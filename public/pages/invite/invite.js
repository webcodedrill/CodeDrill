...
function renderInvitePage(user, backendData) {
  ...
  <div class="invite-page">
    ...
    <!-- Banner Photo -->
    <div style="width:100%;border-radius:16px;overflow:hidden;margin-bottom:24px;display:flex;justify-content:center;background:#0D1117;padding:20px 0;">
      <img src="../../images/codedrill-dp.png" alt="CodeDrill" style="width:280px;height:280px;border-radius:50%;object-fit:cover;display:block;border:3px solid #52b788;">
    </div>
