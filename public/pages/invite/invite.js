...
function renderInvitePage(user, backendData) {
  ...
  <div class="invite-page">
    ...
    <!-- Banner Photo -->
    <div style="width:100%;border-radius:12px;overflow:hidden;margin-bottom:24px;">
      <img src="../../images/og-banner.png" alt="CodeDrill Banner" style="width:100%;display:block;border-radius:12px;">
    </div>
